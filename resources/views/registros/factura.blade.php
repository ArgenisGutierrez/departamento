...
<div class="box-body">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <label>Folio:</label>
      <input name="folio" type="text" class="form-control" placeholder="Ingresa el Folio" required autocomplete="off">
    </div>
    <div class="form-group">
      <label>Importe:</label>
      <input name="importe" type="text" class="form-control" placeholder="Ingresa el Importe" required autocomplete="off">
    </div>
    <div class="form-group">
      <label>Fecha:</label>
    ...
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input name="fecha_envio_area" type="date" class="form-control pull-right">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input name="fecha_recibo_area" type="date" class="form-control pull-right">
      </div>
    </div>
  </div>
  </div>
